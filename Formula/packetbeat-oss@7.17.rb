class PacketbeatOssAT717 < Formula
  desc "Lightweight Shipper for Network Data"
  homepage "https://www.elastic.co/products/beats/packetbeat"
  url "https://artifacts.elastic.co/downloads/beats/packetbeat/packetbeat-oss-7.17.28-darwin-x86_64.tar.gz?tap=elastic/homebrew-tap"
  version "7.17.28"
