class FilebeatOssAT717 < Formula
  desc "File harvester to ship log files to Elasticsearch or Logstash"
  homepage "https://www.elastic.co/products/beats/filebeat"
  url "https://artifacts.elastic.co/downloads/beats/filebeat/filebeat-oss-7.17.28-darwin-x86_64.tar.gz?tap=elastic/homebrew-tap"
  version "7.17.28"
